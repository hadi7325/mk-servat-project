                ...
                <div className='row align-items-center justify-content-center flex'>
                    ...
                    <div className='col-xxl-7 col-xl-7 col-lg-7 col-md-12 col-sm-12'>
                        <div className='home-page-text'>
                            <div className='title'>
                                برای <span>ثروتمند</span> شدن کلی ایده خفن داریم
                            ...
                            <div className='home-page-desc'>
                                ...
                                <div className='counter'>
                                    <div className='item'>
                                        <div className='count' id='count1' data-counter="5235">{counter}</div>
                                        <div className='desc'>لورم ایپسوم متن ساختگی
                                        </div>
                                    </div>
                                    <div className='item'>
                                        <div className='count' id='count2' data-counter="4456">{counter2}</div>
                                        <div className='desc'>لورم ایپسوم متن ساختگی
                                        </div>
                                    </div>
                                </div>
